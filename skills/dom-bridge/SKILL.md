...
1. **Confirm alignment context**
   - Confirm screenshot dimensions, viewport dimensions, coordinate space, scroll position, and device pixel ratio.
   - If DOM coordinates cannot be aligned with the screenshot, return evidence notes without pretending to have precise primitives.
...
- Candidate boxes are in the same coordinate space as the screenshot or are clearly marked as needing conversion.
